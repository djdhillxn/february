...
# Find max word lengths for each file
max_length_file1 = max_word_length(words_file1)
max_length_file2 = max_word_length(words_file2)

# Print the results
print(f"Number of words in file1: {len(words_file1)}")
print(f"Max word length in file1: {max_length_file1}")
print(f"Number of words in file2: {len(words_file2)}")
print(f"Max word length in file2: {max_length_file2}")
